...
def regrid(self, parent_variables, variables, domains, operation, user_id, job_id, process_id):
    _, _, o = self.load(parent_variables, variables, domains, operation)

    def validate(op):
        op.get_parameter('gridder', True)

    return retrieve_base(self, o, None, user_id, job_id, process_id, validate) 

@base.register_process('CDAT.subset', abstract='Subset a variable by provided domain. Supports regridding.')
@base.cwt_shared_task()
def subset(self, parent_variables, variables, domains, operation, user_id, job_id, process_id):
    _, _, o = self.load(parent_variables, variables, domains, operation)
...
@base.cwt_shared_task()
def aggregate(self, parent_variables, variables, domains, operation, user_id, job_id, process_id):
    _, _, o = self.load(parent_variables, variables, domains, operation)

    return retrieve_base(self, o, None, user_id, job_id, process_id) 

def retrieve_base(self, operation, num_inputs, user_id, job_id, process_id, validate=None):
...
""")
@base.cwt_shared_task()
def average(self, parent_variables, variables, domains, operation, user_id, job_id, process_id):
    _, _, o = self.load(parent_variables, variables, domains, operation)
...
""")
@base.cwt_shared_task()
def sum(self, parent_variables, variables, domains, operation, user_id, job_id, process_id):
    _, _, o = self.load(parent_variables, variables, domains, operation)

    return process_base(self, MV.sum, 1, o, user_id, job_id, process_id)
...
""")
@base.cwt_shared_task()
def maximum(self, parent_variables, variables, domains, operation, user_id, job_id, process_id):
    _, _, o = self.load(parent_variables, variables, domains, operation)

    return process_base(self, MV.max, 1, o, user_id, job_id, process_id)
...
string e.g. 'lat|lon'.
                       """)
@base.cwt_shared_task()
def minimum(self, parent_variables, variables, domains, operation, user_id, job_id, process_id):
    _, _, o = self.load(parent_variables, variables, domains, operation)

    return process_base(self, MV.min, 1, o, user_id, job_id, process_id)

def process_base(self, process_func, num_inputs, operation, user_id, job_id, process_id):
