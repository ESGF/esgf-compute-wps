...
from compute_tasks.managers import FileManager
from compute_tasks.managers import InputManager
...
class ESGFDataManager(object):
    ...
    def to_input_manager(self, name, domain=None):
        im = InputManager(self.fm, self.data[name]['files'], self.data[name]['var'])
