...
class KernelTests(unittest.TestCase):
    ...
    def test01(self):
        ...
        request_parms['datainputs'] = [u'[domain=[{"id":"upper","level":{"start":0,"end":1,"system":"indices"}},{"id":"lower","level":{"start":2,"end":3,"system":"indices"}}];variable={"dset":"MERRA/mon/atmos","id":"v0:hur","domain":"upper"};operation=["CDTime.departures(v0,slice:t)","CDTime.climatology(v0,slice:t,bounds:annualcycle)"];]']
