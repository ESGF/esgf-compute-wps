...
tar cf /nfs/tasks-test-data/test_data/*.nc | (mkdir ${PWD}/compute/compute_tasks/test_data; cd ${PWD}/compute/compute_tasks/test_data; tar xvf - --strip-components=3 --absolute-names)
